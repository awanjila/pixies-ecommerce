<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-5xl mx-auto px-4 py-12">
      ...
      <!-- Use of Website -->
      <div class="bg-white rounded-lg shadow-md p-8 mb-8">
        <h2 class="text-2xl font-bold text-gray-900 mb-4">2. Use of Website</h2>
        ...
        <h3 class="text-xl font-semibold text-gray-900 mb-3 mt-6">2.2 Account Responsibilities</h3>
        <p class="text-gray-700 mb-3">If you create an account, you agree to:</p>
        <ul class="space-y-2 ml-6 mb-4">
          <li class="text-gray-700">• Provide accurate, current, and complete information</li>
          <li class="text-gray-700">• Maintain the security of your password and account</li>
          <li class="text-gray-700">• Promptly update your account information if it changes</li>
          <li class="text-gray-700">• Accept responsibility for all activities under your account</li>
          <li class="text-gray-700">• Notify us immediately of any unauthorized use</li>
        </ul>

        <h3 class="text-xl font-semibold text-gray-900 mb-3 mt-6">2.3 Prohibited Activities</h3>
        <p class="text-gray-700 mb-3">You must NOT:</p>
        <ul class="space-y-2 ml-6 mb-4">
          <li class="text-gray-700">• Use the Website for any unlawful purpose</li>
          <li class="text-gray-700">• Attempt to gain unauthorized access to our systems</li>
      ...
      <div class="bg-white rounded-lg shadow-md p-8 mb-8">
        ...
        <h3 class="text-xl font-semibold text-gray-900 mb-3 mt-6">3.1 Pricing</h3>
        <ul class="space-y-2 ml-6 mb-4">
          <li class="text-gray-700">• All prices are displayed in Kenyan Shillings (KES)</li>
          <li class="text-gray-700">• Prices are subject to change without notice</li>
          <li class="text-gray-700">• The price applicable is the price displayed at the time of order confirmation</li>
          <li class="text-gray-700">• Prices exclude delivery charges unless stated otherwise</li>
          <li class="text-gray-700">• We reserve the right to correct pricing errors on our Website</li>
        </ul>
        ...
        <h3 class="text-xl font-semibold text-gray-900 mb-3 mt-6">3.5 Taxes & Fees</h3>
        <p class="text-gray-700">
          All prices include applicable VAT as required by Kenyan law. Additional customs duties or taxes 
      ...
      <div class="bg-white rounded-lg shadow-md p-8 mb-8">
        ...
        <p class="text-gray-700">
          Upon termination, your right to use the Website ceases immediately. Outstanding payment obligations survive termination.
        </p>
      </div>
      ...
      <div class="bg-white rounded-lg shadow-md p-8 mb-8">
        ...
        <p class="text-gray-700">
          We encourage you to review these Terms periodically. The "Effective Date" at the top indicates when these 
      ...
      <div class="mt-8 bg-gray-100 rounded-lg p-6 text-center">
        <p class="text-gray-700 text-sm mb-2">
          <strong>Legal Notice:</strong> These Terms & Conditions are a legally binding agreement.
        </p>
