                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" value="{{$adminUser->name}}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email"  value="{{$adminUser->email}}" >
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" id="phone" value="{{$adminUser->phone}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" id="password" value="{{$adminUser->password}}" >
