...
{{--                                        <abbr title="Phone">Shop Name:</abbr> {{ $customer->shopname }}<br>--}}
                                        ...
                                        <table class="table mt-4 table-centered">
                                            ...
                                            @foreach($contents as $key=> $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->qty }}</td>
                                                    <td>{{ $item->price }}</td>
                                                    <td class="text-end">Ksh {{ $item->price*$item->qty }}</td>
                                                </tr>
                                            @endforeach
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="float-end">
                                        <p><b>Sub-total:</b> <span class="float-end">Ksh {{ Cart::subtotal() }}</span></p>
                                        <p><b>Vat (16%):</b> <span class="float-end"> &nbsp;&nbsp;&nbsp; Ksh {{ Cart::tax() }}</span></p>
                                        <h3>KSh {{ Cart::total() }}</h3>
                                    </div>
...
{{--                                    <a href="javascript:window.print()" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-printer me-1"></i> Print</a>--}}
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#signup-modal">Pay Invoice </button>
                                </div>
                            </div>
                        </div>
                    </div> <!-- end card -->
                ...
                <div class="modal-body">
                    <div class="text-center mt-2 mb-4 ">
                        <div class="auth-logo">
                            ...
                            <h3>Total Amount  Ksh {{ Cart::total() }}</h3>
                        </div>
                    </div>
                    ...
                    <form class="px-3" method="post" action="{{ url('/final-invoice') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="payment_status" class="form-select" id="example-select">
                                ...
                                <option value="Due">Bank Transfer</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="pay" placeholder="Pay Now" value="{{ Cart::total() }}">
                        </div>
