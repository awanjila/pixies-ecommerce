        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{route('expense.store')}}" enctype="multipart/form-data">
                    @csrf
                    <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> Add an expense</h5>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" name="amount" class="form-control @error('name') is-invalid @enderror">
