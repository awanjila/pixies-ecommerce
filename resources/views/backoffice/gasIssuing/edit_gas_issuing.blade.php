                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <h4> Edit Customer Gas Issuin</h4>

                            <h4>
                                <a href=" {{route('employee.attendance.list')}} " class="btn btn-primary float-sm-right"> <i class="fas fa-list"></i>Customers Gas List</a>
                            </h4>
                        </ol>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('gas.issuing.update')}} " method="post" id="myForm">
                            @csrf
                            ...
                            <table class="table sm table-bordered table-striped dt-responsive" style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <th rowspan="2" class="text-center" style="vertical-align: middle">Gas Taken</th>
                                ...
                                <tr>
                                    ...
                                    <th class="text-center btn leave_all" style="display: table-cell;background-color:#114190">Issued</th>
                                ...
                                <tr class="text-center">
                                    <input type="hidden" name="item_id[]" value="{{$item->item_id}}" class="employee_id">
                                    <input type="hidden" name="gas_type" value="{{$item->gas_type}}" class="employee_id">
                                    ...
                                    <td colspan="3">
                                        <div class="switch-toggle switch-3 switch-candy">
                                            <input class="present" id="present{{$key}}" name="issuing_status{{$key}}" value="present" type="radio"
                                                   {{$item->issuing_status == 'Not Issued' ?  'checked': ''}}>
                                            <label for="present{{$key}}">Not Issued</label>


                                            <input class="leave" id="leave{{$key}}" name="issuing_status{{$key}}" value="Leave" type="radio"
                                                {{$item->issuing_status == 'Issued' ?  'checked': ''}}>

                                            <label for="leave{{$key}}">Issued</label>
                                            <input class="absent" id="absent{{$key}}" name="issuing_status{{$key}}" value="Absent" type="radio"
                                                {{$item->issuing_status == 'Returned' ?  'checked': ''}}>
