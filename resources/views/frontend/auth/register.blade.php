...
@section('title')
Register | wabegadgets | Surgical Instruments & Medical Supplies
@endsection
...
<main>
    ...
    <section class="tp-login-area pb-140 p-relative z-index-1 fix">
        <div class="tp-login-shape">
            <img class="tp-login-shape-1" src="{{asset('front-assets/img/login/login-shape-1.png')}}" alt="">
            <img class="tp-login-shape-2" src="{{asset('front-assets/img/login/login-shape-2.png')}}" alt="">
            <img class="tp-login-shape-3" src="{{asset('front-assets/img/login/login-shape-3.png')}}" alt="">
            <img class="tp-login-shape-4" src="{{asset('front-assets/img/login/login-shape-4.png')}}" alt="">
        </div>
        <div class="container">
                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="tp-login-wrapper">
                        ...
                        <div class="tp-login-option">
                            ...
                            <form id="register-form" method="POST" action="{{ route('client.register.post') }}">
                                @csrf
                            ...
                            <div id="error-messages" class="text-danger"></div> <!-- Error messages container -->
                        </div>
                    </div>
                </div>
            </div>
...
// Handling form submission using JavaScript to display errors
document.getElementById('register-form').addEventListener('submit', function(event) {
    ...
    fetch(this.action, {
        ...
        .then(data => {
            ...
            if (data.success) {
                console.log('Form submission successful. Redirecting to:', data.redirect_url);
                // Redirect to success page or handle success accordingly
                window.location.href = data.redirect_url;
            } else {
                console.log('Form submission failed. Displaying validation errors.');
